...
class FleetResourceTest {
    ...
    void modelRecommendationShouldReturn200WithValidParams() {
        given()
                ...
                .then()
                .statusCode(200)
                .body("requiredCapacity", greaterThan(0))
                .body("models", not(empty()));
    }
    ...
    void modelRecommendationShouldMarkOneAsRecommended() {
        given()
                ...
                .then()
                .statusCode(200)
                .body("models.findAll { it.recommended }.size()", equalTo(1));
    }

    @Test
    void modelRecommendationShouldReturn400WhenLineaMissing() {
        given()
                .queryParam("dayType", "weekday")
                .queryParam("occupancy", 80)
                .when().get("/api/fleet/model-recommendation")
    ...
    @Test
    void modelRecommendationShouldReturn404WhenNoDataForLinea() {
        given()
                .queryParam("linea", "linea 99")
                .queryParam("dayType", "weekday")
                .queryParam("occupancy", 80)
    ...
    void modelRecommendationShouldReturnAllFields() {
        given()
                ...
                .then()
                .statusCode(200)
                .body("models[0].id", notNullValue())
                .body("models[0].name", notNullValue())
                .body("models[0].manufacturer", notNullValue())
                .body("models[0].passengerCapacity", notNullValue())
                .body("models[0].autonomyKm", notNullValue())
                .body("models[0].unitCostUsd", notNullValue())
                .body("models[0].recommended", notNullValue());
    }
